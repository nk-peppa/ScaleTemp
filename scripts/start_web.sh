...
[ScaleTemp] For real HX711 hardware, run:
  ./scripts/start_web.sh --hardware DATA_GPIO SCK_GPIO [GAIN_PULSES]
Or export SCALETEMP_SENSOR_MODE=sysfs, SCALETEMP_DATA_GPIO, and SCALETEMP_SCK_GPIO.
MSG
  fi
fi
